-- ============================================================
-- vResolve PostgreSQL Schema
-- Run this on EC2 2 (Database Server)
-- ============================================================
...
-- ── FEED POST LIKES (to track who liked what) ────────────────
...
-- ── VAULT POSTS (anonymous) ──────────────────────────────────
CREATE TABLE vault_posts (
  id          UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  body        TEXT NOT NULL,
...
CREATE INDEX idx_vault_posts_created  ON vault_posts(created_at DESC);
CREATE INDEX idx_wellness_user_date   ON wellness(user_id, date);
...
INSERT INTO feed_posts (author_id, body, likes)
VALUES
  ('00000000-0000-0000-0000-000000000001', 'Sometimes the hardest part is just showing up. Proud of everyone here 💪', 12),
  ('00000000-0000-0000-0000-000000000002', 'Just completed my 30-day meditation streak! Small steps, big changes 🧘', 7);

INSERT INTO vault_posts (body, ai_reply, thinking)
VALUES
  ('Feeling overwhelmed with work lately. Not sure how to cope.',
   'As the Bhagavad Gita teaches in Chapter 2, Verse 47: focus on your duties, not the outcome. Each moment of effort is complete in itself.',
   FALSE);